...
class RegionController extends AbstractController
{
    ...
    /**
     * @Route("/{id}", name="region_show", requirements={ "id": "\d+"}, methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="region_edit", requirements={ "id": "\d+"}, methods={"GET","POST"})
     * @IsGranted("ROLE_USER")
     */
    ...
    /**
     * @Route("/{id}", name="region_delete", requirements={ "id": "\d+"}, methods={"POST"})
     * @IsGranted("ROLE_USER")
     */
